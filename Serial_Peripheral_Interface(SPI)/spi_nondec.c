...
int main(){
    ...
    while(1){
      ...
      ssp_spi_write(0x0100);// write blank to digit-0 display unit
      ssp_spi_write(0x0200);// write blank to digit-1 display unit
      ssp_spi_write(0x0300);// write blank to digit-2 display unit
      ssp_spi_write(0x0400);// write blank to digit-0 display unit
